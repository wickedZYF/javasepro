...
public class StreamDemo04 {
    ...
    public static double allMoney2;//两个部门去掉最低和最高工资的组合
    public static void main(String[] args) {
        ...
        // 1、开发一部的最高工资的员工。（API）
        // 指定大小规则了
//        Employee e=one.stream().max((e1,e2)->Double.compare(e1.getSalary()+e1.getBonus(),e2.getBonus()+e2.getSalary())).get();
//        System.out.println(e);
        ...
        System.out.println("开发二部的平均工资是："+allMoney/(one.size()-2));
